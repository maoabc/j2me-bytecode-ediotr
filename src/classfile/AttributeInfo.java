...
public abstract class AttributeInfo {
    ...
    Attribute(int n,int l){
        attributeNameIndex=n;
        attributeLength=l;
    }
    ...
    public static class CodeAttribute extends Attribute {
        ...
        CodeAttribute(int anameIndex,int alength,int maxs,int maxl,int clength,int[] cod,int elength,ExceptionEntry[] entry,int acount,AttributeInfo[] attri){
            super(anameIndex,alength);
            maxStack=maxs;
            maxLocals=maxl;
            codeLength=clength;
            code=cod;
            exceptionTableLength=elength;
            exceptionTable=entry;
            attributesCount=acount;
            attributes=attri;
        }
        public CodeAttribute(int name){
            this(name,13,0,0,1,new int[]{0xb1},0,(ExceptionEntry[])null,0,(AttributeInfo[])null);
        }
...
//             return (ExceptionEntry[]) Arrays.copyOf(exceptionTable, exceptionTable.length); 
    ...
    public static class ExceptionsAttribute extends Attribute {
        ...
        ExceptionsAttribute(int anameIndex,int alength,int num,int[] ei){
            super(anameIndex,alength);
            numberOfExceptions=num;
            exceptionIndexTable=ei;
        }
        public ExceptionsAttribute(int name){
            this(name,2,0,(int[])null);
        }
